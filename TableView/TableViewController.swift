...
//  TableView
//
//  Created by Kameron Haramoto on 2/7/17.
...
class TableViewController: UITableViewController {
    ...
    @IBAction func unwindFromAddEntry (segue: UIStoryboardSegue) { let addVC = segue.source as! AddEntryViewController
        if (addVC.newCharacterReady) {
            let name = addVC.AddEntryTextField.text!
